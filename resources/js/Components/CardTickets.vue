...
<template>
    <div v-if="isCardView" class="grid gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        <div v-for="ticket in tickets" :key="ticket.id" class="relative w-full">
            ...
            <div class="relative h-full p-6 bg-white border-2 rounded-lg" :class="{
    ...
    <div v-else class="overflow-x-auto">
        <table class="min-w-full bg-white border-collapse rounded-lg shadow-lg">
            <thead class="text-sm leading-normal text-gray-600 uppercase bg-gray-200">
                <tr>
                    <th v-for="header in headers" :key="header" class="px-6 py-3 border-b">
                        {{ header }}
                    </th>
